...
<div class="flex h-full flex-col justify-between">
    <ScrollArea>
        ...
        <div class="mb-4 px-5">
            <p class="text-muted-foreground mb-2 text-[10px] tracking-widest uppercase">Delivery</p>
            <div class="flex flex-col gap-2 text-xs">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class={functions.getResponseCodeColor(currentSelectedEvent.response_code)}>
